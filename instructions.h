...
#define INSTRUCTION_BR   (OPCODE_BR)
...
#define INSTRUCTION_BRNZ (INSTRUCTION_BRN | INSTRUCTION_BRZ)
#define INSTRUCTION_BRNP (INSTRUCTION_BRN | INSTRUCTION_BRP)
#define INSTRUCTION_BRZP (INSTRUCTION_BRZ | INSTRUCTION_BRP)
#define INSTRUCTION_BRNZP (INSTRUCTION_BRNZ | INSTRUCTION_BRP)
